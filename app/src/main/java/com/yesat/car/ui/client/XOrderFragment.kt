...
import com.yesat.car.ui.client.active.XOrderAListFragment
import com.yesat.car.ui.client.posted.XOrderPListFragment
...
class XOrderFragment : Fragment() {
    ...
    inner class OrderPagesAdapter(fm: FragmentManager) : FragmentStatePagerAdapter(fm) {
        ...
        private var tabs = arrayOf("Posted", "Active")
